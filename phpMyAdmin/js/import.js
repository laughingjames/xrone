...
AJAX.registerOnload('import.js', function () {
    ...
    $(document).on('submit', '#import_file_form', function (event) {
        ...
        var fileMsg = '<div class="error"><index-img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> ' + PMA_messages.strImportDialogMessage + '</div>';
        ...
        if (radioLocalImport.length !== 0) {
            ...
            if (! radioLocalImport.is(":checked") && ! radioImport.is(":checked")) {
                radioImport.focus();
                var msg = '<div class="error"><index-img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> ';
            ...
            if (radioLocalImport.is(":checked")) {
                if ($("#select_local_import_file").length === 0) {
                    PMA_ajaxShowMessage('<div class="error"><index-img src="themes/dot.gif" title="" alt="" class="icon ic_s_error" /> ' + PMA_messages.strNoImportFile + ' </div>', false);
                    return false;
                }
