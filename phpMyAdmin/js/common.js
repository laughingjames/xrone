...
var PMA_commonActions = {
     ...
     *                  String to go to a different page, e.g: 'Index.phpob.php'
     *
     * @return void
     */
...
PMA_DROP_IMPORT = {
    ...
    _importFinished: function(hash, aborted, status) {
        ...
        // Set icon
        $('.pma_sql_import_status div li[data-hash="' +hash +'"]')
            .prepend('<index-img src="./themes/dot.gif" title="finished" class="' +
            icon +'"> ');
        ...
        if (dbname !== '') {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                $(".pma_sql_import_status div").append('<li data-hash="' +hash +'">' +
                    ((ext !== '') ? '' : '<index-img src="./themes/dot.gif" title="invalid format" class="icon ic_s_notice"> ') +
