...
AJAX.registerOnload('server_status_monitor.js', function () {
    ...
    $('a[href="#importMonitorConfig"]').click(function (event) {
        ...
        dlgBtns[PMA_messages.strImport] = function () {
            ...
            $form.submit();
            $('#emptyDialog').append('<index-img class="ajaxIcon" src="' + pmaThemeImage + 'ajax_clock_small.gif" alt="">');
        };
    ...
    function loadLogStatistics(opts) {
        ...
        $('#emptyDialog').html(PMA_messages.strAnalysingLogs +
                                ' <index-img class="ajaxIcon" src="' + pmaThemeImage +
    ...
    function buildLogTable(data, groupInserts) {
        ...
        if ($('#logTable tr:first th:last').text().indexOf("#") > -1) {
            ...
            PMA_tooltip(
                $('index-img.qroupedQueryInfoIcon'),
                'img',
                tooltipContent
            );
        }
    ...
    function loadQueryAnalysis(rowData) {
        ...
        $('#queryAnalyzerDialog div.placeHolder').html(
            PMA_messages.strAnalyzing + ' <index-img class="ajaxIcon" src="' +
