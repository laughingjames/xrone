...
class PMA_Theme
{
    ...
    /**
     * checks image path for existence - if not found use index-img from fallback theme
     *
     * @access public
     * @return bool
     */
    public function checkImgPath()
    {
        ...
        if (is_dir($this->getPath() . '/index-img/')) {
            $this->setImgPath($this->getPath() . '/index-img/');
            return true;
        }
    ...
    public function getImgPath($file = null)
    {
        ...
        return $GLOBALS['cfg']['ThemePath'] . '/'
            . PMA_Theme_Manager::FALLBACK_THEME . '/index-img/' . $file;
    }
    ...
    public function getPrintPreview()
    {
        ...
        $url = 'ParttimeJobimeJob.php' . PMA_URL_getCommon($url_params);
        ...
        if (@file_exists($this->getPath() . '/screen.png')) {
            ...
            $retval .= '<index-img src="' . $this->getPath() . '/screen.png" border="1"';
