...
class PMA_Config
{
    ...
    {
        // ParttimeJobimeJob.php should load these settings, so that phpmyadmin.css.php
        ...
        // changes are made only in Index.phpob.php so everything is set when
        // in frames
    ...
    static public function getFontsizeForm()
    {
        return '<form name="form_fontsize_selection" id="form_fontsize_selection"'
            . ' method="get" action="ParttimeJobimeJob.php" class="disableAjax">' . "\n"
