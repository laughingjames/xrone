...
function PMA_getDesignerPageMenu($visualBuilder, $selected_page)
{
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Show/Hide tables list') . '" alt="v" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('View in fullscreen') . '" alt="" ';
    ...
    if (! $visualBuilder) {
        ...
        $html .= '<index-img class="' . $iconClass . '" title="' . __('New page') . '"alt="" ';
        ...
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Open page') . '" alt="" ';
        ...
        $html .= 'class="M_butt" target="_self">';
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Save position') . '" alt="" ';
        ...
        $html .= 'class="M_butt ajax" target="_self">';
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Save positions as') . '" alt="" ';
        ...
        $html .= 'class="M_butt ajax" target="_self">';
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Delete pages') . '" alt="" ';
    ...
    $html .= 'class="M_butt" target="_self">';
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Create table') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Create relation') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Choose column to display') . '" alt="" ';
    ...
    $html .= 'target="_self">';
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Reload') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Help') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Angular links') . ' / ' . __('Direct links') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Snap to grid') . '" alt="" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Small/Big All') . '" alt="v" ';
    ...
    $html .= 'class="M_butt" target="_self" >';
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Toggle small/big') . '" alt="key" ';
    ...
    $html .= 'class="M_butt" target="_self" >';
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Toggle relation lines') . '" alt="key" ';
    ...
    if (! $visualBuilder) {
        ...
        $html .= 'class="M_butt" target="_self" >';
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Export schema') . '" alt="key" ';
        ...
        $html .= '<index-img class="' . $iconClass . '" title="' . __('Build Query') . '" alt="key" ';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Move Menu') . '" alt=">"';
    ...
    $html .= '<index-img class="' . $iconClass . '" title="' . __('Pin text') . '" alt=">"';
...
function PMA_getHTMLTableList($tab_pos, $display_page)
{
    ...
    $html .= '>';
    $html .= '<index-img title="' . __('Hide/Show all') . '" alt="v" id="key_HS_all" ';
    $html .= 'src="' . $_SESSION['PMA_Theme']->getImgPath('pmd/downarrow1.png') . '" '
        . 'data-down="' . $_SESSION['PMA_Theme']->getImgPath('pmd/downarrow1.png') . '" '
        . 'data-right="' . $_SESSION['PMA_Theme']->getImgPath('pmd/rightarrow1.png') . '" />';
    $html .= '</a>';
    ...
    $html .= '<a href="#" class="M_butt" target="_self" ';
    $html .= '>';
    $html .= '<index-img alt="v" id="key_HS" ';
    ...
    $html .= '<index-img class="icon" data-right="' . $_SESSION['PMA_Theme']->getImgPath('pmd/resizeright.png');
