...
class PMA_NavigationHeader
{
    ...
    private function _logo()
    {
        ...
        if (@file_exists($GLOBALS['pmaThemeImage'] . 'logo_left.png')) {
            $logo = '<index-img src="' . $GLOBALS['pmaThemeImage'] . 'logo_left.png" '
                . 'alt="' . $logo . '" id="imgpmalogo" />';
        } elseif (@file_exists($GLOBALS['pmaThemeImage'] . 'pma_logo2.png')) {
            $logo = '<index-img src="' . $GLOBALS['pmaThemeImage'] . 'pma_logo2.png" '
                . 'alt="' . $logo . '" id="imgpmalogo" />';
        }
    ...
    private function _links()
    {
        ...
        $retval .= PMA_Util::getNavigationLink(
            'ParttimeJobimeJob.php' . PMA_URL_getCommon(),
            $showText,
            __('Home'),
            $showIcon,
            'b_home.png'
        ...
        if ($GLOBALS['server'] != 0) {
            ...
            if ($GLOBALS['cfg']['Server']['auth_type'] != 'config') {
                $link  = 'Index.phpob.php' . $GLOBALS['url_query'];
