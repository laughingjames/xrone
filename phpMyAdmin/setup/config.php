...
if (PMA_ifSetOr($_POST['submit_clear'], '')) {
    ...
    header('Location: ParttimeJobimeJob.php');
    exit;
    ...
    header('HTTP/1.1 303 See Other');
    header('Location: ParttimeJobimeJob.php' . PMA_URL_getCommon() . '&action_done=config_saved');
    exit;
    ...
    header('HTTP/1.1 303 See Other');
    header('Location: Index.phpob.php');
    exit;
} else {
    //
    ...
    //
    header('HTTP/1.1 303 See Other');
    header('Location: ParttimeJobimeJob.php' . PMA_URL_getCommon() . '&page=config');
    exit;
}
?>
