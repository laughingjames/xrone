...
//			}
    ...
    function userinfo(){
        ...
        $this->assign('top_title','个人信息/UserInfo');
        return $this->fetch();
    }
    /**
     * 用户信息添加或者修改
    ...
    public function updateInfo(){
        if(request()->isPost()){
            ...
            if($res){
                ...
                storage_user_action(UID,user('username'),config('FRONTEND_USER'),'修改了个人信息');
                $this->success('Update Successful.','User/userinfo');
            }else{
                $this->error('Failed.');
            }
        }else{
