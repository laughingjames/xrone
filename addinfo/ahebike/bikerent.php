...
<p>
  <?php
	if(isset($_POST['btn']))
	{
		...
		$sql ="insert into bikerent values(null,'$username','$phonenum','$sno','$bikenum','$notes','$time')";
		...
		<div class="container">
			<div class="row">
                ...
                <form id="form1" class="form-horizontal" name="form1" method="post" action="" onSubmit="return check()"> 
                 ...
                 <div class="form-group"><input type="text" class="form-control" name="phonenum" id="phonenum" placeholder="手机号码"><i class="fa fa-user"></i> </div>
				 <div class="form-group"> <input type="text" class="form-control" name="sno" id="sno" placeholder="学号(没有学号请输入一个0)"><i class="fa fa-user"></i> </div>
                 <div class="form-group"> <input type="text" class="form-control" name="bikenum" id="bikenum" placeholder="车号"> <i class="fa fa-user"></i> </div>
				 <div class="form-group"> <input type="text" class="form-control" name="notes" id="notes" placeholder="备注说明(填写押金等)"><i class="fa fa-user"></i> </div> 	
                 <p>&nbsp; </p>					                 
