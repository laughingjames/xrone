		...
		<div class="container">
			<div class="row">
                ...
                <form id="form1" class="form-horizontal" name="form1" method="post" action="" onSubmit="return check()"> 
						<span class="heading">B区车库电动车保管</span>
				 ...
				 <div class="form-group"> <input type="text" class="form-control" name="sno" id="sno" placeholder="学号"><i class="fa fa-user"></i> </div>
                 <div class="form-group"> <input type="text" class="form-control" name="bikenum" id="bikenum" placeholder="车牌号"> <i class="fa fa-user"></i> </div>
				 <div class="form-group"> <input type="text" class="form-control" name="notes" id="notes" placeholder="备注"><i class="fa fa-user"></i> </div> 
                 <p>&nbsp; </p>						                 
