...
//                echo "文件临时存储的位置: " . $_FILES["file"]["tmp_name"] . "<br>";
        ...
        if (file_exists("house_pic/" . $pic_url)) {
            //  echo $_FILES["file"]["name"] . " 文件已经存在。 ";

        }
        else {
            // 如果 upload 目录不存在该文件则将文件上传到 upload 目录下
            move_uploaded_file($_FILES["file"]["tmp_name"], "house_pic/" .$pic_url);
            //   echo "文件存储在: " . "house_pic/" .  $pic_url;
        }
    }
    ...
    $sql ="insert into wechat_house_renting values(null,'$title','$detail','$pic_url','$price')";
    echo $sql;
    if(mysql_query($sql)){
//            echoURL();
        echo '写入成功！';
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 clearfix">
                            ...
                            <div class="upload-container pull-left">
                                <input id="file" type="file" name="" value="" multiple accept="image/png,image/gif,image/jpg,image/jpeg" />
...
<div style="text-align:center;">
    <p>来源:<a href="http://www.xrone.cn/" target="_blank">0+1工作室</a>
    </p>
</div>
