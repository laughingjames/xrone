...
<?php
		...
		$rs=mysql_query('select name,phone_no,passport_no,h.time time,h.id house_id  from wechat_apply_house h,wechat_house_renting r WHERE h.house_id = r.id order by time desc');

?>
<h1 align="center">房屋申请表</h1>
<table class="altrowstable" id="alternatecolor" width="100%" border="1" cellpadding="2" cellspacing="0">
<tr> 
	<th>序号</th><th>姓名</th><th>手机号</th><th>护照号</th><th>房子ID</th><th>时间</th><th>删除</th><th>修改</th>
 <?php
  $i=1;
