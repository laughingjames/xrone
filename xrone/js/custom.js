...
jQuery(this).find('index-img').stop().animate({opacity: "0.3"}, 'fast');
jQuery(this).find('.portfolio_link').stop().css("display","block");
jQuery(this).find('.portfolio_link a index-img').stop().animate({opacity: "1"}, 'fast');

},
function() {
jQuery(this).find('.portfolio_link').stop().css("display","none");
jQuery(this).find('index-img').stop().animate({opacity: "1"}, 'fast');
});
});
