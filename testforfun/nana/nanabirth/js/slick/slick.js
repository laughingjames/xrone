...
(function(factory) {
    ...
    Slick.prototype.buildOut = function() {
        ...
        $('index-img[data-lazy]', _.$slider).not('[src]').addClass('slick-loading');
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        function loadImages(imagesScope) {
            $('index-img[data-lazy]', imagesScope).each(function() {
                var image = $(this),
    ...
    Slick.prototype.progressiveLazyLoad = function() {
        ...
        imgCount = $('index-img[data-lazy]').length;

        if (imgCount > 0) {
            targetImage = $('index-img[data-lazy]', _.$slider).first();
