    ...
    var weReadIndexIE8 = function() {
        var e = {
            ...
            setStyle: function() {
                ...
                $('#background').remove();
                $('#view').prepend('<index-img id="background_ie" src="images/background.jpg">');
                $('#page_download_hand').remove();
                $('#page_download').prepend('<index-img id="page_download_hand_ie" src="images/download_hand.png">');
                $('#logo').remove();
                $('#view').prepend('<index-img id="logo_ie" src="images/logo.png">');
                $('#arrow_right').remove();
                $('#view').prepend('<index-img id="arrow_right" src="images/ie/ie_arrow_right.png">');
                $('#arrow_left').remove();
                $('#view').prepend('<index-img id="arrow_left" src="images/ie/ie_arrow_left.png">');
                $('#page_function1_show').remove();
                $('#page_function1').prepend('<index-img id="page_function1_show" src="images/ie/ie_function1.png">');
                $('#page_function2_show').remove();
                $('#page_function2').prepend('<index-img id="page_function2_show" src="images/ie/ie_function2.png">');
                $('#page_function3_show').remove();
                $('#page_function3').prepend('<index-img id="page_function3_show" src="images/ie/ie_function3.png">');
                $('#page_function4_table').remove();
                $('#page_function4').prepend('<index-img id="page_function4_table" src="images/ie/ie_function4.png">');
